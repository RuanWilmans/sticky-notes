...
LANGUAGE_CODE="en-us"; TIME_ZONE="Africa/Johannesburg"; USE_I18N=True; USE_TZ=True
STATIC_URL="static/"; STATICFILES_DIRS=[BASE_DIR / "notes" / "static"]; STATIC_ROOT= BASE_DIR / "static"
